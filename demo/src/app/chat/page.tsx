...
export default function ChatPage() {
  ...
  useEffect(() => {
    if (message) {
      // Bộ công thương yêu cầu tiền kiểm duyệt các từ khóa nhạy cảm.
      var bannedKeywords = ['sex', 'cá độ', 'lô đề', 'đánh bạc', 'ma túy', 'bạo lực', 'khủng bố'];
      var regex = new RegExp(bannedKeywords.join('|'), 'i');
